...
class _PropertySelectorWidgetState extends State<PropertySelectorWidget> {
  ...
  Widget? buildPropertyOption() {
    ...
    for(ProductPropertyandValue property in widget.currentVariant.productPropertiesValues){
      debugPrint('current variant properties: ${property.property} ${property.value}');
    }
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: widget.currentVariant.getColorValue() == color
                        ? isDarkMode
                            ? (getColorFromHex(color) == Colors.white)? Colors.grey : Colors.white
                            : (getColorFromHex(color) == Colors.black)? Colors.grey : Colors.black
                        : Colors.grey,
